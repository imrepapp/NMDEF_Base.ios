Pod::Spec.new do |s|
  s.name         = "MicrosoftAzureMobile-Xapt"
  s.version      = "3.4.1"
  s.summary      = "Client SDK for working with Azure Mobile Apps."
  s.homepage     = "https://github.com/ambri/azure-mobile-apps-ios-client.git"
  s.license      = "Apache License, Version 2.0"
  s.author             = "Microsoft"
  s.platform = :ios, '9.0'
  s.frameworks = "WebKit"
  s.source       = {
    :git => "https://github.com/ambri/azure-mobile-apps-ios-client.git",
    :tag => "3.4.0-xapt"
  }
